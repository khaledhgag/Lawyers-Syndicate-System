...
import { booksApi, statsApi } from '../../api/services.js';
...
export default function BooksAdmin() {
  ...
  const deleteAll = async () => {
    ...
    if (!window.confirm(`⚠️ سيتم حذف كل الكتب (${total.toLocaleString('ar-EG')}) نهائياً مع ملفاتها. لا يمكن التراجع. هل أنت متأكد؟`)) return;
    ...
    try {
      ...
      for (let i = 0; i < queue.length; i += BATCH) {
        ...
        try {
          ...
          console.error('Book bulk upload failed', {
